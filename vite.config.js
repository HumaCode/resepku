    ...
    plugins: [
        laravel({
            input: [
                ...
                'resources/css/backend/resep.css',
                'resources/js/backend/resep.js',
                'resources/css/backend/resep-create.css',
                'resources/js/backend/resep-create.js',
                'resources/js/backend/resep-edit.js',
                'resources/css/backend/resep-detail.css',
                'resources/js/backend/resep-detail.js',
            ],
            refresh: true,
        }),
    ],
