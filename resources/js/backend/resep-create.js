...
window.addIngredient = function() {
  ...
  row.innerHTML = `
    ...
    <div class="ing-qty" ><input type="number" class="form-input" placeholder="0" min="0" step="any"/></div>
    <div class="ing-unit">
...
function renumberSteps() {
  ...
  stepCount = document.querySelectorAll('#stepList .step-item').length;
}
