...
<head>
  ...
  <title>403 — Akses Ditolak — {{ config('app.name', 'ResepKita') }}</title>
...
<body>
  ...
  <!-- Blobs -->
  <div class="blob" style="width:400px;height:400px;background:rgba(239,68,68,.08);top:-110px;right:-110px"></div>
  <div class="blob" style="width:280px;height:280px;background:rgba(232,93,38,.07);bottom:-70px;left:-70px"></div>
  ...
  <div class="error-wrap">
    ...
    <div class="error-card" style="--stripe:linear-gradient(90deg,#f87171,#ef4444)">
      ...
      <span class="error-pill" style="background:rgba(239,68,68,.09);border:1.5px solid rgba(239,68,68,.28);color:#dc2626"><i class="bi bi-shield-lock-fill"></i> Forbidden — 403</span>
      <h1 class="error-title">Akses Ditolak</h1>
      <p class="error-desc">{{ $exception->getMessage() ?: 'Kamu tidak memiliki izin untuk mengakses halaman ini. Hubungi administrator jika kamu merasa seharusnya bisa masuk.' }}</p>

      
      <div class="login-hint">
        <div class="lh-icon"><i class="bi bi-person-lock"></i></div>
        <div class="lh-text">
          @auth
            Kamu login sebagai <strong>{{ auth()->user()->name ?? auth()->user()->username }}</strong>.<br>
          @else
            Kamu belum login ke sistem.<br>
          @endauth
          Jika butuh akses ke halaman ini, hubungi administrator sistem.
        </div>
      </div>
      ...
      <div class="error-tips">
        <div class="error-tips-ttl"><i class="bi bi-info-circle"></i> Mengapa ini terjadi?</div>
        <div class="tip-item"><i class="bi bi-check2"></i> Role akun kamu tidak memiliki permission ke halaman ini</div>
        <div class="tip-item"><i class="bi bi-check2"></i> Sesi login mungkin sudah kedaluwarsa — coba login ulang</div>
        <div class="tip-item"><i class="bi bi-check2"></i> Halaman ini mungkin khusus untuk role tertentu</div>
      </div>
